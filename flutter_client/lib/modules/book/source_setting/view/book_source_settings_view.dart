...
import '../controller/book_source_settings_controller.dart';
import '../models/book_source.dart';

const double _kBaseCardWidth = 400;
const double _kCardHeight = 320;

class BookSourceSettingsView extends StatelessWidget {
  const BookSourceSettingsView({super.key});

  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final customColors = Theme.of(context).extension<CustomColors>();
    final isNarrow = DeviceUtils.isPhone(context);
    final topPad = MediaQuery.paddingOf(context).top;
    return GetBuilder<BookSourceSettingsController>(
      init: BookSourceSettingsController(),
      builder: (ctrl) {
        return Container(
          ...
          child: isNarrow
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            child: Text('book_source_scan_all'.tr),
                          ),
                          IconButton(
                            tooltip: 'refresh'.tr,
                            onPressed: () =>
              ...
              : Column(
                  children: [
                    Padding(
                      padding: EdgeInsets.fromLTRB(16, topPad + 12, 16, 10),
                      child: Row(
                        children: [
                          Text(
                            'settings_source'.tr,
  ...
  Future<void> _pickAndAdd(
    ...
    BookSourceSettingsController ctrl,
  ) async {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    'book_source_add_card'.tr,
                    style: theme.textTheme.titleSmall,
                    textAlign: TextAlign.center,
                  ),
                  IconButton(
                    tooltip: 'book_source_help_add_source'.tr,
                    onPressed: () {
                      DialogUtil.showInfoDialog(
                        title: 'tip'.tr,
                        content: 'book_source_help_add_source'.tr,
                        buttonText: 'ok'.tr,
                      );
                    },
                    icon: Icon(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('book_source_add_card'.tr, style: theme.textTheme.titleSmall),
          ],
        ),
      ),
    );
...
class _MobileSourceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final ctrl = Get.find<BookSourceSettingsController>();
    ...
    final availability = source.exists
        ? 'book_source_available'.tr
        : 'book_source_unavailable'.tr;

    Future<void> delete() async {
      final confirmed = await DialogUtil.showConfirmDialog(
        title: 'need_confirm'.tr,
        content: 'book_source_delete_confirm'.trParams({'path': source.path}),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    if (source.exists)
                      TextButton(
                        ...
                        child: Text('book_source_scan_now'.tr),
                      ),
                    TextButton(
                      onPressed: delete,
                      child: Text(
            ...
            switchRow(
              title: 'book_source_scan_when_start'.tr,
              value: source.scanWhenStart == 1,
              helpMessage: 'book_source_help_scan_when_start'.tr,
              onChanged: (v) =>
                  ctrl.updateSourceOptimistic(source, scanWhenStart: v ? 1 : 0),
            ),
            switchRow(
              title: 'book_source_scan_when_change'.tr,
              value: source.scanWhenChange == 1,
              helpMessage: 'book_source_help_scan_when_change'.tr,
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Row(
                      children: [
                        Flexible(child: Text('book_source_scan_interval'.tr)),
                        IconButton(
                          padding: EdgeInsets.zero,
                          constraints: const BoxConstraints(
                            minWidth: 32,
                          ...
                          tooltip: 'book_source_help_scan_interval'.tr,
                          onPressed: () {
                            DialogUtil.showInfoDialog(
                              title: 'tip'.tr,
                              content: 'book_source_help_scan_interval'.tr,
                              buttonText: 'ok'.tr,
                            );
                          },
                          icon: Icon(
            ...
            if (intervalEnabled)
              Padding(
                ...
                child: Row(
                  children: [
                    Text('book_source_scan_interval_hours'.tr),
                    const Spacer(),
                    DropdownButton<int>(
                      value: hours,
                      items: List.generate(
            ...
            Row(
              children: [
                Expanded(
                  child: Row(
                    children: [
                      Flexible(child: Text('book_source_show_type'.tr)),
                      IconButton(
                        padding: EdgeInsets.zero,
                        constraints: const BoxConstraints(
                          minWidth: 32,
                        ...
                        tooltip: 'book_show_type_alert'.tr,
                        onPressed: () {
                          DialogUtil.showInfoDialog(
                            title: 'tip'.tr,
                            content: 'book_source_show_type_switch_confirm'.tr,
                            buttonText: 'ok'.tr,
                          );
                        },
                        icon: Icon(
                ...
                DropdownButton<String>(
                  value: (source.showType.isNotEmpty
                      ...
                      : 'book'),
                  items: [
                    DropdownMenuItem(value: 'book', child: Text('file'.tr)),
              ...
              children: [
                ...
                Expanded(
                  child: Row(
                    children: [
                      Text(
                        '[${(source.exists ? 'book_source_available' : 'book_source_unavailable').tr}]',
                        style: theme.textTheme.labelMedium?.copyWith(
                          color: source.exists ? Colors.green : Colors.red,
                        ),
                      ),
                ...
                if (source.exists)
                  CustomBorderedIconButton(
                    tooltip: 'book_source_scan_now'.tr,
                    icon: Icons.refresh,
                ...
                CustomBorderedIconButton(
                  ...
                  onTap: () async {
                    final confirmed = await DialogUtil.showConfirmDialog(
                      title: 'need_confirm'.tr,
                      content: 'book_source_delete_confirm'.trParams({
                        'path': source.path,
                      }),
                      confirmText: 'delete'.tr,
                      cancelText: 'cancel'.tr,
