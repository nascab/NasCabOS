...
import '../service/book_collection_api_service.dart';

class BookCollectionController extends GetxController {
  static const String keySortField = 'book_collection_sort_field';
  static const String keySortOrder = 'book_collection_sort_order';

  final BookCollectionApiService _api = BookCollectionApiService();

  final RxBool isLoading = false.obs;
  final RxBool hasMore = true.obs;
  final RxList<BookCollectionItem> items = <BookCollectionItem>[].obs;
  ...
  final Rxn<BookCollectionItem> activeCollection = Rxn<BookCollectionItem>();
  ...
  void openCollection(BookCollectionItem collection) {
