...
class PhotoCollectionController extends GetxController {
  static const String keySortField = 'photo_collection_sort_field';
  static const String keySortOrder = 'photo_collection_sort_order';

  final PhotoCollectionApiService _api = PhotoCollectionApiService();

  final RxBool isLoading = false.obs;
  final RxBool hasMore = true.obs;
  final RxList<PhotoCollectionItem> items = <PhotoCollectionItem>[].obs;
  ...
  final Rxn<PhotoCollectionItem> activeCollection = Rxn<PhotoCollectionItem>();
  ...
  void openCollection(PhotoCollectionItem collection) {
