...
import '../../controller/music_multi_select_controller.dart';

class MusicListMultiSelectBottomBar extends StatelessWidget {
  final MusicMultiSelectController controller;
  const MusicListMultiSelectBottomBar({super.key, required this.controller});
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: disabled ? null : controller.addToPlayListSelected,
                  icon: Icon(Icons.playlist_add),
                ),
                if (controller.isInPlayList)
                  IconButton(
                    tooltip: 'remove_from_play_list'.tr,
                    onPressed: disabled
                        ? null
                        : controller.removeFromPlayListSelected,
