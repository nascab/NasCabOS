...
class tableBookFavorite {
  constructor() {
    this.tableName = 'book_favorite';
  }
  ...
  async createTable(connection = null) {
    ...
    if (!exists) {
      ...
      Logger.info(`✅ book_favorite table created`);
    }
  }
  ...
  async createIndexes(connection = null) {
    ...
    const idxUnique = 'idx_book_fav_uid_index_unique';
    ...
    if (!uniqueExists) {
      ...
      Logger.info(`✅ book_favorite unique index created`);
    }

    const idxUid = 'idx_book_fav_uid';
    ...
    if (!uidExists) {
      ...
      Logger.info(`✅ book_favorite index (uid) created`);
    }

    const idxIndexId = 'idx_book_fav_index_id';
    ...
    if (!indexIdExists) {
      ...
      Logger.info(`✅ book_favorite index (index_id) created`);
    }

    const idxCreateTime = 'idx_book_fav_uid_create_time';
    ...
    if (!createTimeExists) {
      ...
      Logger.info(`✅ book_favorite index (uid,create_time) created`);
    }
  }
}

module.exports = new tableBookFavorite();
