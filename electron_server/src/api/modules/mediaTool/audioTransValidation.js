...
const AudioTransValidation = {
  ...
  validateUpsert() {
    return [
      ...
      body('trans_config').notEmpty().withMessage('validation.VALIDATION_ERROR'),
      body('non_audio_policy').notEmpty().isIn(['skip', 'copy']).withMessage('validation.VALIDATION_ERROR'),
    ];
  },
...
module.exports = AudioTransValidation;
