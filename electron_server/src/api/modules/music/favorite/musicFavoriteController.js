...
const MusicFavoriteService = require('./musicFavoriteService');

class MusicFavoriteController {
  async add(req, res) {
    try {
      const user = req.user;
      ...
      const service = new MusicFavoriteService(req.dbMusic);
...
module.exports = new MusicFavoriteController();
