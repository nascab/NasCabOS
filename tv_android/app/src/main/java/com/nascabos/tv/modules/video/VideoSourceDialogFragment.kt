...
class VideoSourceDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val title =
            TextView(ctx).apply {
                text = getString(R.string.video_list_action_sources)
        ...
        fun emitSelection() {
            ...
            parentFragmentManager.setFragmentResult(
                ...
                bundleOf(VideoGridFragment.RESULT_FIELD_SOURCES to picked),
            )
        }
        emitSelection()
    ...
    companion object {
        ...
        fun newInstance(availablePaths: ArrayList<String>, selectedPaths: ArrayList<String>): VideoSourceDialogFragment {
            return VideoSourceDialogFragment().apply {
