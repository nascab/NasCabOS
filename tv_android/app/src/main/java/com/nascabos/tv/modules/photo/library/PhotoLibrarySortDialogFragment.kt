...
class PhotoLibrarySortDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        listView.setOnItemClickListener { _, _, position, _ ->
            ...
            parentFragmentManager.setFragmentResult(
                PhotoLibraryGridFragment.RESULT_KEY_SORT,
                bundleOf(
                    PhotoLibraryGridFragment.RESULT_FIELD_SORT_FIELD to e.field.name,
                    PhotoLibraryGridFragment.RESULT_FIELD_SORT_ORDER to e.order.name,
                ),
            )
    ...
    private fun sortEntries(): List<SortEntry> {
        return listOf(
            SortEntry(PhotoLibrarySortField.CreateTime, PhotoLibrarySortOrder.Desc, R.string.video_library_sort_create_time_desc),
            SortEntry(PhotoLibrarySortField.CreateTime, PhotoLibrarySortOrder.Asc, R.string.video_library_sort_create_time_asc),
            SortEntry(PhotoLibrarySortField.Name, PhotoLibrarySortOrder.Asc, R.string.video_library_sort_name_asc),
            SortEntry(PhotoLibrarySortField.Name, PhotoLibrarySortOrder.Desc, R.string.video_library_sort_name_desc),
        )
    }
    ...
    companion object {
        ...
        fun newInstance(currentSortField: String, currentSortOrder: String): PhotoLibrarySortDialogFragment {
            return PhotoLibrarySortDialogFragment().apply {
